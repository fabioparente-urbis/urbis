...
create table if not exists mac_slot5_filtros (
  ...
  -- O que sai da análise quando o filtro aciona. Os dois convivem: grupos
  -- inteiros e itens avulsos somam.
...
select * from (values
  ('APRO DE PROJ', 'Aprovação nova — não é modificação de projeto já aprovado', 10,
  ...
  ('COMERCIAL', 'Sem uso habitacional — cai tudo que é exclusivo de habitação', 20,
  ...
  ('S/ ONEROSA', 'Sem outorga onerosa e sem TDC', 30,
   ...
   array['COEFICIENTE DE APROVEITAMENTO BÁSICO NÃO ONEROSO E ONEROSO Art. 242 LC N°349 /2022) E TDC']),
  ...
  ('S/ BAIA DE DES', 'Sem baia de desaceleração de velocidade', 40,
   ...
   array['BAIA DE DESACELERAÇÃO DE VELOCIDADE']),
  ...
  ('NÃO É PENSÃO', 'Sem quitinete, pensão, pensionato ou casa de estudantes', 50,
   ...
   array['PENSAO, PENSIONATO E CASA DE ESTUDANTES – LC nº364/2023 – Art. 121']),
