...
cat > /Users/fabiomartinssantos/lip-interface/app/login/page.tsx << 'ENDOFFILE'
"use client";
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Image src="/urbis.png" alt="URBIS" width={220} height={90} className="mx-auto mb-2" />
          <p className="text-slate-400 text-sm mt-2">Sistema de Analise de Projetos</p>
          <p className="text-slate-500 text-xs mt-1">Prefeitura de Goiania</p>
        </div>
...
echo "Login page criada com sucesso!"
wc -l /Users/fabiomartinssantos/lip-interface/app/login/page.tsx
