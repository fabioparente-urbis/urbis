    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <header className="bg-[var(--bg-primary)] border-b border-[var(--border)] px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold text-[var(--text-primary)] inline-flex items-center gap-2 ml-4"><Settings2 size={20} /> {abaAtual === "geral" ? "Configurações — Geral" : abaAtual === "logradouros" ? "Configurações — Logradouros" : "MAP — Módulo de Auditoria e Produtividade"}</h1>
        </div>
