    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <header className="bg-[var(--bg-primary)] border-b border-[var(--border)] px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-1">
          ...
          {isAdmin && <button onClick={() => setAbaAtual("pontuacao")} className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-colors ${abaAtual === "pontuacao" ? "bg-[var(--accent)] text-[var(--text-primary)]" : "text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--surface)]"}`}>🎯 Pontuação</button>}
