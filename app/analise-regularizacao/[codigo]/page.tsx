    ...
    try {
      ...
      fetch("/api/mrp/registros", {
        ...
        body: JSON.stringify({
          ...
          numero_revisao: numeroRevisao,
          area_construida: Number(dadosLip?.areaConstruida?.valor ?? dadosLip?.area_construida?.valor ?? dadosLip?.areaConstruida ?? dadosLip?.area_construida ?? 0),
          interessado: dadosLip?.interessado?.valor ?? dadosLip?.interessado ?? null,
          bairro: dadosLip?.bairro?.valor ?? dadosLip?.bairro ?? null,
