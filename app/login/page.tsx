  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md text-center">
        ...
        <p className="text-sm text-[var(--text-muted)] mb-6">Sistema de Análise de Projetos — Prefeitura de Goiânia</p>

        <div className="flex flex-col gap-4 text-left">
          <div>
            <label className="text-xs text-[var(--text-muted)] font-semibold uppercase tracking-wide block mb-1">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="text-xs text-[var(--text-muted)] font-semibold uppercase tracking-wide block mb-1">Senha</label>
            <input
              type="password"
              value={senha}
        ...
        <div className="mt-3 text-right">
          <button
            ...
            className="text-xs text-blue-600 hover:text-[var(--accent)] hover:underline"
          >
        ...
        {modoReset && (
          <div className="mt-3 bg-slate-50 border border-slate-200 rounded-lg p-3 text-left">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
            />
            <button
              onClick={enviarLinkReset}
              disabled={enviandoReset}
              className="w-full mt-2 bg-[var(--bg-secondary)] hover:bg-[var(--surface)] disabled:opacity-50 text-[var(--primary-text)] font-semibold py-2 rounded-lg text-sm transition-colors"
            >
