...
**Versão:** 14 · **Data:** 10/09/2026 · **Estado:** em implantação — **Fases 0, 1, 1B e 2
concluídas, Fase 3 abolida** (4 de 15 fases: **~27% concluído, 73% restante**) — migration da
Fase 1 aplicada e CONFIRMADA em produção (consulta direta ao banco), commits liberados pra push
