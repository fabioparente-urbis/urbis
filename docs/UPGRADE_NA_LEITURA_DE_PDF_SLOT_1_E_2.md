...
**Versão:** 20 · **Data:** 11/09/2026 · **Estado:** em implantação — **Fases 0, 1, 1B e 2
concluídas, Fase 3 abolida, Fase 4 com CÓDIGO concluído, Fase 5 em duas rodadas, Fase 6 com NÚCLEO
implementado, Fase 7 e 8 implementadas** (8 de 15 fases com trabalho real — Fase 5 e 6 continuam
abertas por natureza, ver §6/§7) — migrations das Fases 1, 4 e 5 (duas) APLICADAS e confirmadas em
produção; migration da Fase 8 (`documentos_ia_cache`) escrita, ainda não aplicada — fail-safe
(consultado sem tabela existir, cai no comportamento de sempre). Pushes feitos até o commit da
Fase 8, madrugada de 11/09/2026, a pedido explícito do Fábio antes de dormir ("se der ruim a gente
reverte o commit amanhã").
