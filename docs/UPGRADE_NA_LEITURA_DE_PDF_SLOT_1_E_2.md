...
**Versão:** 24 · **Data:** 11/09/2026 · **Estado:** em implantação — **Fases 0, 1, 1B e 2
concluídas, Fase 3 abolida, Fase 4 com CÓDIGO concluído, Fase 5 em duas rodadas, Fase 6 com NÚCLEO
implementado, Fase 7, 8 e 9A implementadas, Fase 9B pendente** (10 de 16 fases com trabalho real —
Fase 3 abolida virou 9A/9B nesta versão, sem renumerar 10-14; Fase 5 e 6 continuam abertas por
natureza, ver §6/§7) — migrations das Fases 1, 4 e 5 (duas) APLICADAS e confirmadas em produção;
migration da Fase 8 (`documentos_ia_cache`) escrita, ainda não aplicada — fail-safe; migration da
Fase 9A (`leitura_unica_lip_mac_ativo`) **aplicada e confirmada em produção em 11/09/2026**. Pushes
feitos até o commit da Fase 9A, 11/09/2026.
